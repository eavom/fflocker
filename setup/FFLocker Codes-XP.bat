...
echo ----------------------------------------------------------------
echo.
echo Sorry, Wrong Choice, Try again...
pause
goto CSQUE
...
echo ----------------------------------------------------------------
echo.
set/p "conf=_       Press Y to Confirm : "
IF "%conf%"=="" goto WRNCONF
IF "%conf%"=="Y" goto STOREDATA
IF "%conf%"=="y" goto STOREDATA
IF "%conf%"=="N" goto CNAME
IF "%conf%"=="n" goto CNAME
goto WRNCONF
...
echo.
echo ----------------------------------------------------------------
set/p "confblog=_              Do you want to visit our blog : "
IF "%confblog%"=="" goto WRNCONFBLOG
IF "%confblog%"=="Y" goto GOTOBLOG
IF "%confblog%"=="y" goto GOTOBLOG
IF "%confblog%"=="N" goto SELECT
IF "%confblog%"=="n" goto SELECT
goto WRNCONFBLOG
...
echo ----------------------------------------------------------------
echo.
set/p "confua=Select your Choice : "
IF "%confua%"=="" goto WRNCONFUA
IF "%confua%"=="1" goto LOCKFF
IF "%confua%"=="2" goto UNLOCKFF
IF "%confua%"=="3" goto CHPASS
IF "%confua%"=="4" goto UINFO
IF "%confua%"=="5" goto HELPME
IF "%confua%"=="6" goto LBATCH
IF "%confua%"=="X" goto CLOSE
IF "%confua%"=="x" goto CLOSE
goto WRNCONFUA
...
echo.
echo ----------------------------------------------------------------
set/p "confbatch=_              Do you want to DOWNLOAD : "
IF "%confbatch%"=="" goto WRNCONFBATCH
IF "%confbatch%"=="Y" goto DWLBATCH
IF "%confbatch%"=="y" goto DWLBATCH
IF "%confbatch%"=="N" goto USERAREA
IF "%confbatch%"=="n" goto USERAREA
goto WRNCONFBATCH
...
echo.
echo ----------------------------------------------------------------
set/p "confbl=_              Do you want to visit our blog : "
IF "%confbl%"=="" goto WRNCONFBLOG2
IF "%confbl%"=="Y" goto GOTOBLOG2
IF "%confbl%"=="y" goto GOTOBLOG2
IF "%confbl%"=="N" goto USERAREA
IF "%confbl%"=="n" goto USERAREA
goto WRNCONFBLOG2
...
echo ----------------------------------------------------------------
echo.
set/p "confui=_                   Can I Proceed : "
IF "%confui%"=="" goto WRNCONFUI
IF "%confui%"=="Y" goto DELDATA
IF "%confui%"=="y" goto DELDATA
IF "%confui%"=="N" goto USERAREA
IF "%confui%"=="n" goto USERAREA
goto WRNCONFUI
...
echo in "DATA" folder and your "DATA" Folder is in E: Drive Then you 
echo have to write,
echo.
echo                     E:\EDUFILE\DATA
echo ----------------------------------------------------------------
...
echo ----------------------------------------------------------------
echo.
set/p "conflockff=What you want to Lock : "
IF "%conflockff%"=="" goto WRNCONFLOCKFF
IF "%conflockff%"=="1" goto FOFFILE
IF "%conflockff%"=="2" goto FOFFOLDER
goto WRNCONFLOCKFF
...
echo ----------------------------------------------------------------
echo.
set/p "cul=What you want to Lock : "
IF "%cul%"=="" goto WRNCONFUNLOCKFF
IF "%cul%"=="1" goto UNFOFFILE
IF "%cul%"=="2" goto UNFOFFOLDER
goto WRNCONFUNLOCKFF
...
echo -----------------------------------------------------------------
echo.
set/p "confc=_              Are you sure you want to close : "
IF "%confc%"=="" goto WRNCONFC
IF "%confc%"=="Y" goto EXIT
IF "%confc%"=="y" goto EXIT
IF "%confc%"=="N" goto SELECT
IF "%confc%"=="n" goto SELECT
goto WRNCONFC
...
:SETUPCOMP
copy "FFLocker Codes-XP.bat" D:\
attrib "D:\FFLocker Codes-XP.bat" +s +h
...
echo IF EXIST "D:\FFLocker Codes-XP.bat" goto START >> "FFLocker 1.0.bat"
...
echo CALL "D:\FFLocker Codes-XP.bat" >> "FFLocker 1.0.bat"
echo.  >> "FFLocker 1.0.bat"
echo REM ############################ >> "FFLocker 1.0.bat"
...
echo y| del "FFLocker Codes-XP.bat"
exit
REM ############################################################
